...
<div class="container">
    <div class="form-group">
        ...
        <div class="col-md-2 col-sm-3 col-xs-4">
            <div class="pull-right">
                ...
                {{link_to_route('bunches::subscribers.edit', 'Edit', [$bunch_id, $subscriber->id], ['class' => 'btn btn-primary btn-xs']) }}
    ...
    <a class="btn btn-info btn-xs col-md-1 col-sm-2 col-xs-2" href="{{ URL("bunches/".$bunch_id."/subscribers")}}"><i class="fa fa-backward" aria-hidden="true"></i>Back</a>
</div>
@endsection